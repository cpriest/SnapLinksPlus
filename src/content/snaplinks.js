...
//		this.XulDocument.getElementById('statusbar-display').label = x;
	...
	initialize: function(ChromeWindow, XulDocument) {
		...
		this.LocaleBundle = Services.strings.createBundle("chrome://snaplinksplus/locale/snaplinks.properties?" + Math.random() /* 8/8/2014: Hack for Restartless Addons re: Cache */);
